...
def show_venue(venue_id):
 ...
 # data=db.session.query.get(venue_id)
   ...
   #   data = Venue.query.all()
    ...
    "genres":data1.genres ,
     "image_link":data1.image_link,
      ...
      "num_upcoming_shows":data1.num_upcoming_shows,
      "seeking_talent":data1.seeking_talent,
     "past_shows":data1.past_shows,
      "show":data1.shows

      }
    showinfo=Show.query.filter_by(venue_id=venue_id).all()
    print(data1.name)
    #print(data2)
    #data = list(data2)[0]
    
    return render_template('pages/show_venue.html', venue=data ,show=showinfo)
...
def create_venue_submission():
  ...
  try:
    ...
    db.session.close()
  return render_template('pages/home.html')
  # TODO1: insert form data as a new Venue record in the db, instead
  # TODO1: modify data to be the data object returned from db insertion

  # on successful db insert, flash success
  # TODO1: on unsuccessful db insert, flash an error instead.
...
def delete_venue(venue_id):
  # TODO1: Complete this endpoint for taking a venue_id, and using
...
def create_show_submission():
  ...
  # TODO1: insert form data as a new Show record in the db, instead
  try:
